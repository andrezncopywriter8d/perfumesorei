...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-6xl -mt-6 mx-auto h-full w-full border-4 border-amber-500/20 p-2 md:p-4 bg-[#0a0506] rounded-[30px] shadow-2xl"
    >
      <div className="h-full w-full overflow-hidden rounded-2xl bg-[#0a0506]">
        {children}
      </div>
    </motion.div>
  );
